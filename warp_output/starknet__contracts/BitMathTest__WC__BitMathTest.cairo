...
namespace BitMathTest:
    ...
    func s1___warp_usrfn0_mostSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1{
        ...
        if __warp_se_38 != 0:
            ...
            let (
                __warp_se_40
            ) = s1___warp_usrfn0_mostSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1(
                __warp_usrid1_r
            )
    ...
    func s1___warp_usrfn0_mostSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1(
        __warp_usrid1_r : felt
    ) -> (__warp_usrid1_r : felt):
        alloc_locals
    ...
    func s1___warp_usrfn1_leastSignificantBit{
        ...
        let (__warp_se_42) = warp_gt256(__warp_usrid2_x, Uint256(low=0, high=0))

        assert __warp_se_42 = 1

        let __warp_usrid3_r = 255

        let (__warp_se_43) = warp_uint256(340282366920938463463374607431768211455)

        let (__warp_se_44) = warp_bitwise_and256(__warp_usrid2_x, __warp_se_43)

        let (__warp_se_45) = warp_gt256(__warp_se_44, Uint256(low=0, high=0))

        if __warp_se_45 != 0:
            let (__warp_se_46) = warp_sub(__warp_usrid3_r, 128)

            let __warp_usrid3_r = __warp_se_46
            ...
            let (__warp_se_48) = warp_shr256(__warp_usrid2_x, 128)

            let __warp_usrid2_x = __warp_se_48

            let (__warp_se_49) = s1___warp_usrfn1_leastSignificantBit_if_part1(
                __warp_usrid2_x, __warp_usrid3_r
            )
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1{
        ...
        let (__warp_se_50) = warp_uint256(18446744073709551615)

        let (__warp_se_51) = warp_bitwise_and256(__warp_usrid2_x, __warp_se_50)

        let (__warp_se_52) = warp_gt256(__warp_se_51, Uint256(low=0, high=0))

        if __warp_se_52 != 0:
            let (__warp_se_53) = warp_sub(__warp_usrid3_r, 64)

            let __warp_usrid3_r = __warp_se_53
            ...
            let (__warp_se_55) = warp_shr256(__warp_usrid2_x, 64)

            let __warp_usrid2_x = __warp_se_55

            let (__warp_se_56) = s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1(
                __warp_usrid2_x, __warp_usrid3_r
            )
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1{
        ...
        let (__warp_se_57) = warp_uint256(4294967295)

        let (__warp_se_58) = warp_bitwise_and256(__warp_usrid2_x, __warp_se_57)

        let (__warp_se_59) = warp_gt256(__warp_se_58, Uint256(low=0, high=0))

        if __warp_se_59 != 0:
            let (__warp_se_60) = warp_sub(__warp_usrid3_r, 32)

            let __warp_usrid3_r = __warp_se_60
            ...
            let (__warp_se_62) = warp_shr256(__warp_usrid2_x, 32)

            let __warp_usrid2_x = __warp_se_62

            let (__warp_se_63) = s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1(
                __warp_usrid2_x, __warp_usrid3_r
            )
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1{
        ...
        let (__warp_se_64) = warp_uint256(65535)

        let (__warp_se_65) = warp_bitwise_and256(__warp_usrid2_x, __warp_se_64)

        let (__warp_se_66) = warp_gt256(__warp_se_65, Uint256(low=0, high=0))

        if __warp_se_66 != 0:
            let (__warp_se_67) = warp_sub(__warp_usrid3_r, 16)

            let __warp_usrid3_r = __warp_se_67
            ...
            let (__warp_se_69) = warp_shr256(__warp_usrid2_x, 16)

            let __warp_usrid2_x = __warp_se_69
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1{
        ...
        let (__warp_se_71) = warp_uint256(255)

        let (__warp_se_72) = warp_bitwise_and256(__warp_usrid2_x, __warp_se_71)

        let (__warp_se_73) = warp_gt256(__warp_se_72, Uint256(low=0, high=0))

        if __warp_se_73 != 0:
            let (__warp_se_74) = warp_sub(__warp_usrid3_r, 8)

            let __warp_usrid3_r = __warp_se_74
            ...
            let (__warp_se_76) = warp_shr256(__warp_usrid2_x, 8)

            let __warp_usrid2_x = __warp_se_76
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1{
        ...
        let (__warp_se_78) = warp_bitwise_and256(__warp_usrid2_x, Uint256(low=15, high=0))

        let (__warp_se_79) = warp_gt256(__warp_se_78, Uint256(low=0, high=0))

        if __warp_se_79 != 0:
            let (__warp_se_80) = warp_sub(__warp_usrid3_r, 4)

            let __warp_usrid3_r = __warp_se_80
            ...
            let (__warp_se_82) = warp_shr256(__warp_usrid2_x, 4)

            let __warp_usrid2_x = __warp_se_82
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1{
        ...
        let (__warp_se_84) = warp_bitwise_and256(__warp_usrid2_x, Uint256(low=3, high=0))

        let (__warp_se_85) = warp_gt256(__warp_se_84, Uint256(low=0, high=0))

        if __warp_se_85 != 0:
            let (__warp_se_86) = warp_sub(__warp_usrid3_r, 2)

            let __warp_usrid3_r = __warp_se_86
            ...
            let (__warp_se_88) = warp_shr256(__warp_usrid2_x, 2)

            let __warp_usrid2_x = __warp_se_88
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1{
        ...
        let (__warp_se_90) = warp_bitwise_and256(__warp_usrid2_x, Uint256(low=1, high=0))

        let (__warp_se_91) = warp_gt256(__warp_se_90, Uint256(low=0, high=0))

        if __warp_se_91 != 0:
            let (__warp_se_92) = warp_sub(__warp_usrid3_r, 1)

            let __warp_usrid3_r = __warp_se_92

            let (
                __warp_se_93
            ) = s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1(
                __warp_usrid3_r
            )
    ...
    func s1___warp_usrfn1_leastSignificantBit_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1_if_part1(
        __warp_usrid3_r : felt
    ) -> (__warp_usrid3_r : felt):
        alloc_locals
